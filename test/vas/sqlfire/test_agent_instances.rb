...
module Sqlfire
  ...
  class TestAgentInstances < VasTestCase
    ...
    def test_instance
      ...
      client.expect(:post, nil, ['https://localhost:8443/sqlfire/v1/groups/2/agent-instances/4/state/', {:status => 'STARTED'}])
      client.expect(:post, nil, ['https://localhost:8443/sqlfire/v1/groups/2/agent-instances/4/state/', {:status => 'STOPPED'}])
    ...
    def test_delete
      client = StubClient.new
      agent_instances = AgentInstances.new('https://localhost:8443/sqlfire/v1/groups/1/agent-instances/', client)
