  ...
  class TestAgentNodeInstances < VasTestCase
    ...
    def test_list
      instances = AgentNodeInstances.new(
          'https://localhost:8443/sqlfire/v1/nodes/1/agent-instances/',
          StubClient.new)
    ...
    def test_instance
      location = 'https://localhost:8443/sqlfire/v1/nodes/1/agent-instances/2/'
      ...
      client.expect(:post, nil, ['https://localhost:8443/sqlfire/v1/nodes/0/agent-instances/3/state/', { :status => 'STARTED'}])
      client.expect(:post, nil, ['https://localhost:8443/sqlfire/v1/nodes/0/agent-instances/3/state/', { :status => 'STOPPED'}])
