  ...
  class TestLocatorPendingConfigurations < VasTestCase
    ...
    def test_list
      configurations = LocatorPendingConfigurations.new(
          'https://localhost:8443/sqlfire/v1/groups/1/locator-instances/2/configurations/pending/',
          StubClient.new)
    ...
    def test_create
      ...
      pending_configurations_location = 'https://localhost:8443/sqlfire/v1/groups/1/locator-instances/2/configurations/pending/'
    ...
    def test_pending_configuration
      location = 'https://localhost:8443/sqlfire/v1/groups/0/locator-instances/1/configurations/pending/2/'

      client = StubClient.new
      pending_configuration = LocatorPendingConfiguration.new(location, client)
  
      assert_equal('https://localhost:8443/sqlfire/v1/groups/0/locator-instances/1/configurations/pending/2/', pending_configuration.location)
      assert_equal('sqlfire.properties', pending_configuration.path)
      assert_equal(10537, pending_configuration.size)
      assert_equal('https://localhost:8443/sqlfire/v1/groups/0/locator-instances/1/', pending_configuration.instance.location)
      ...
      client.expect(:post, nil, ['https://localhost:8443/sqlfire/v1/groups/0/locator-instances/1/configurations/pending/2/content/', 'the new content'])
    ...
    def test_delete
      client = StubClient.new
      configurations = LocatorPendingConfigurations.new(
          'https://localhost:8443/sqlfire/v1/groups/1/locator-instances/2/configurations/pending/', client)

      location = 'https://localhost:8443/sqlfire/v1/groups/0/locator-instances/1/configurations/pending/2/'
      client.expect(:delete, nil, [location])

      configurations.delete(LocatorPendingConfiguration.new(location, client))
