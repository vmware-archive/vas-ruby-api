...
module Sqlfire
  ...
  class TestServerInstances < VasTestCase
    ...
    def test_instance
      ...
      client.expect(:post, nil, ['https://localhost:8443/sqlfire/v1/groups/2/server-instances/4/state/', {:status => 'STARTED', :serial => false}])
      client.expect(:post, nil, ['https://localhost:8443/sqlfire/v1/groups/2/server-instances/4/state/', {:status => 'STOPPED', :serial => false}])
      client.expect(:post, nil, ['https://localhost:8443/sqlfire/v1/groups/2/server-instances/4/state/', {:status => 'STARTED', :serial => true}])
      client.expect(:post, nil, ['https://localhost:8443/sqlfire/v1/groups/2/server-instances/4/state/', {:status => 'STOPPED', :serial => true}])
    ...
    def test_delete
      ...
      ServerInstance.new(instance_location, client).delete
      client.verify
    end
