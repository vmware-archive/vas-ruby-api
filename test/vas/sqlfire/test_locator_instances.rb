...
module Sqlfire
  ...
  class TestLocatorInstances < VasTestCase
    ...
    def test_instance
      ...
      client.expect(:post, nil, ['https://localhost:8443/sqlfire/v1/groups/2/locator-instances/4/state/', {:status => 'STARTED'}])
      client.expect(:post, nil, ['https://localhost:8443/sqlfire/v1/groups/2/locator-instances/4/state/', {:status => 'STOPPED'}])
