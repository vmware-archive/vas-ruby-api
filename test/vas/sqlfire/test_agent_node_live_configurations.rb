  ...
  class TestAgentNodeLiveConfigurations < VasTestCase
    ...
    def test_list
      configurations = AgentNodeLiveConfigurations.new(
          'https://localhost:8443/sqlfire/v1/nodes/1/agent-instances/2/configurations/live/',
          StubClient.new)
    ...
    def test_details
      location = 'https://localhost:8443/sqlfire/v1/nodes/1/agent-instances/2/configurations/live/3/'
      ...
      assert_equal('https://localhost:8443/sqlfire/v1/nodes/0/agent-instances/3/', node_live_configuration.instance.location)
      assert_equal('https://localhost:8443/vfabric/v1/security/6/', node_live_configuration.security.location)
      assert_equal('https://localhost:8443/sqlfire/v1/nodes/1/agent-instances/2/configurations/live/3/', node_live_configuration.location)
      assert_equal('https://localhost:8443/sqlfire/v1/groups/1/agent-instances/2/configurations/live/4/', node_live_configuration.group_configuration.location)
