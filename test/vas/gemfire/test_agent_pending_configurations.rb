  ...
  class TestAgentPendingConfigurations < VasTestCase
    ...
    def test_list
      configurations = AgentPendingConfigurations.new(
          'https://localhost:8443/gemfire/v1/groups/1/agent-instances/2/configurations/pending/',
          StubClient.new)
    ...
    def test_create
      ...
      pending_configurations_location = 'https://localhost:8443/gemfire/v1/groups/1/agent-instances/2/configurations/pending/'
    ...
    def test_pending_configuration
      ...
      client.expect(:post, nil, ['https://localhost:8443/gemfire/v1/groups/0/agent-instances/1/configurations/pending/2/content/', 'the new content'])
