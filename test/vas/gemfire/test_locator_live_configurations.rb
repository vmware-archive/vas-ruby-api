...
module Gemfire
  ...
  class TestLocatorLiveConfigurations < VasTestCase
    ...
    def test_live_configuration
      ...
      assert_equal('https://localhost:8443/gemfire/v1/groups/1/locator-instances/2/', live_configuration.instance.location)
      ...
      assert_equal('https://localhost:8443/gemfire/v1/nodes/0/locator-instances/3/configurations/live/6/', live_configuration.node_configurations[0].location)
      assert_equal('https://localhost:8443/gemfire/v1/nodes/0/locator-instances/4/configurations/live/7/', live_configuration.node_configurations[1].location)
