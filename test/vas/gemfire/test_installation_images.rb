...
module Gemfire
  ...
  class TestInstallationImages < VasTestCase
    ...
    def test_installation_image
      location = "https://localhost:8443/gemfire/v1/installation-images/1/"
      ...
      assert_equal('https://localhost:8443/gemfire/v1/groups/1/installations/2/', installation_image.installations[1].location)
      assert_equal('https://localhost:8443/vfabric/v1/security/5/', installation_image.security.location)
    end

    def test_delete
      client = StubClient.new
      installation_images = InstallationImages.new('https://localhost:8443/gemfire/v1/installation-images/', client)
