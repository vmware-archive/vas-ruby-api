...
module Gemfire
  ...
  class TestLocatorInstances < VasTestCase
    ...
    def test_instance
      ...
      client.expect(:post, nil, ['https://localhost:8443/gemfire/v1/groups/2/locator-instances/4/state/', {:status => 'STARTED', :serial => false}])
      client.expect(:post, nil, ['https://localhost:8443/gemfire/v1/groups/2/locator-instances/4/state/', {:status => 'STOPPED', :serial => false}])
      client.expect(:post, nil, ['https://localhost:8443/gemfire/v1/groups/2/locator-instances/4/state/', {:status => 'STARTED', :serial => true}])
      client.expect(:post, nil, ['https://localhost:8443/gemfire/v1/groups/2/locator-instances/4/state/', {:status => 'STOPPED', :serial => true}])
