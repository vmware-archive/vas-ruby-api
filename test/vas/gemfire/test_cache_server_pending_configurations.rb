  ...
  class TestCacheServerPendingConfigurations < VasTestCase
    ...
    def test_list
      configurations = CacheServerPendingConfigurations.new(
          'https://localhost:8443/gemfire/v1/groups/1/cache-server-instances/2/configurations/pending/',
          StubClient.new)
    ...
    def test_create
      ...
      pending_configurations_location = 'https://localhost:8443/gemfire/v1/groups/1/cache-server-instances/2/configurations/pending/'
      configurations = CacheServerPendingConfigurations.new(pending_configurations_location, client)
    ...
    def test_pending_configuration
      ...
      client = StubClient.new
      pending_configuration = CacheServerPendingConfiguration.new(location, client)
  
      assert_equal('https://localhost:8443/gemfire/v1/groups/0/cache-server-instances/1/configurations/pending/2/', pending_configuration.location)
      assert_equal('gemfire.properties', pending_configuration.path)
      assert_equal(10537, pending_configuration.size)
      assert_equal('https://localhost:8443/gemfire/v1/groups/0/cache-server-instances/1/', pending_configuration.instance.location)
      ...
      client.expect(:post, nil, ['https://localhost:8443/gemfire/v1/groups/0/cache-server-instances/1/configurations/pending/2/content/', 'the new content'])
