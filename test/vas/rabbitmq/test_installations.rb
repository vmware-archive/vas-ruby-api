...
module RabbitMq
  ...
  class TestInstallations < VasTestCase
    ...
    def test_create
      ...
      installation_image_location = 'https://localhost:8443/rabbitmq/v1/installation-images/1/'
    ...
    def test_installation
      installation = Installation.new('https://localhost:8443/rabbitmq/v1/groups/1/installations/2/', StubClient.new)
  
      assert_equal('https://localhost:8443/rabbitmq/v1/groups/1/installations/2/', installation.location)
      assert_equal('https://localhost:8443/rabbitmq/v1/installation-images/0/', installation.installation_image.location)
      assert_equal('https://localhost:8443/rabbitmq/v1/groups/1/', installation.group.location)
    ...
    def test_delete
      client = StubClient.new
      installations = Installations.new('https://localhost:8443/rabbitmq/v1/groups/1/installations/', client)
