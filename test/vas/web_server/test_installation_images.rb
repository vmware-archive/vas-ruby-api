  ...
  class TestInstallationImages < VasTestCase
    ...
    def test_list
      installation_images = InstallationImages.new(
          "https://localhost:8443/web-server/v1/installation-images/",
          StubClient.new)
    ...
    def test_installation_image
      location = "https://localhost:8443/web-server/v1/installation-images/1/"
      ...
      assert_equal('https://localhost:8443/web-server/v1/groups/3/installations/4/', installation_image.installations[1].location)
